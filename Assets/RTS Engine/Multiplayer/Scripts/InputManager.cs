        ...
        public void LaunchCommand(InputVars Command)
        {
            ...
            { //spawning the faction capital building
                ...
                { //if the faction belongs to a certain type
                    ...
                    Capital = Instantiate(GameMgr.FactionDef[FactionTypeID].CapitalBuilding.gameObject, Command.InitialPos, GameMgr.FactionDef[FactionTypeID].CapitalBuilding.transform.rotation);
                }
